...
export class Snake extends EventManager {
  ...
  private initialize(length: number): void {
    // Create head light with optimized properties
    this.headLight = new PointLight(0x4a7c59, 2.5, 15, 2);
    this.headLight.castShadow = false; // Disable shadows for better performance
